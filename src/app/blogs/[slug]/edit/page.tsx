...
// Add 'Love' to the categories
const categories = ['Technology', 'Lifestyle', 'Health', 'Travel', 'Love'];
...
const postFormSchema = z.object({
  ...
  excerpt: z.string().min(10).max(200).optional().or(z.literal('')),
  imageUrl: z.string().url({ message: 'Please enter a valid URL.' }).optional().or(z.literal('')),
  tags: z.string().optional(), // Comma-separated tags stored as a single string in the form
});
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              <Textarea id="content" rows={10} {...register('content')} disabled={isSubmitting} placeholder="Write your blog post content here..." />
             ...
             <div>
               ...
               <Input id="imageUrl" type="url" {...register('imageUrl')} placeholder="https://example.com/image.jpg" disabled={isSubmitting} />
